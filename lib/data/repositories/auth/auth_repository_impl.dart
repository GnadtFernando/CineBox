    ...
    switch (result) {
      case Success<String>(:final value):
        try {
          ...
          return Failure(
            DataException(message: 'Erro ao autenticar com o backend'),
          );
        }
      case Failure<String>(:final error):
        log('Erro ao realizar login', name: 'AuthRepositoryImpl', error: error);
        return Failure(DataException(message: 'Erro ao realizar login'));
    }
  }
